...
import com.tata.imta.bean.CityModel;
import com.tata.imta.bean.DistrictModel;
import com.tata.imta.bean.ProvinceModel;
import com.tata.imta.helper.LogHelper;
import com.tata.imta.helper.XmlParserHandler;
...
public class CityInfoHolder {
    ...
    public void initProvinceDatas(Context context)
    {
        ...
        AssetManager asset = context.getAssets();//context.getAssets();
        try {
            InputStream input = asset.open("city/city_data.xml");
            // 创建一个解析xml的工厂对象
        ...
        if(mProvinceDatas != null) {
            LogHelper.debug(this, "init provinceList size:"+mProvinceDatas.length);
        }
    }
}
