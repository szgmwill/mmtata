...
public class ImageCache {
    ...
    public void setIcon(ImageView iconView,GotyeUser user){
        ...
        if(bmp!=null){
            ...
            if(bmp!=null){
                ...
                iconView.setImageResource(R.drawable.head_icon_user);//如果找不到合适图片,给一个默认图
    ...
    public void setIcon(ImageView iconView,GotyeGroup group){
