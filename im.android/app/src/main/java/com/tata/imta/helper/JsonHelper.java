...
public class JsonHelper {
        ...
        try {      
            if (null != value && !"".equals(value)) {      
                if ("String".equals(fieldType)) {     
                    ...
                    LogHelper.error(JsonHelper.class, ">>>>setFiedlValue -> not supper type" + fieldType);
                }   
            }  
                  
        } catch (Exception e) {     
            LogHelper.error(JsonHelper.class, ">>>>>>>>>>set value error.", e);
            e.printStackTrace();  
        }     
    ...
    public static <T> T parseObject(String jsonStr, Class<T> clazz) {
        try {
            ...
            LogHelper.error(JsonHelper.class, "parseObject ["+jsonStr+"] error", e);
